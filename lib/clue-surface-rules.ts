...
${ruleNum + 1}. Capitalise the first word of the clue and the first word after any full stop, exclamation mark, or question mark, plus any names or places; all other words must be lowercase (e.g. "Perhaps John agency in chaos for a roster member (6,4)" or "Sham needs sorting for a warming winter mash (4)" — not "John, Agency In Chaos"). Do not add decorative padding before wordplay when the definition follows (no "Lost at sea? Help me" style filler).`;
}
